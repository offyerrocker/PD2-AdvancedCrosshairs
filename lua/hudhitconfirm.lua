HUDHitConfirm._orig_on_hit_confirmed = Hooks:GetFunction(HUDHitConfirm,"on_hit_confirmed")
...
HUDHitConfirm._orig_on_hs_confirmed = Hooks:GetFunction(HUDHitConfirm,"on_headshot_confirmed")
...
HUDHitConfirm._orig_on_crit_confirmed = Hooks:GetFunction(HUDHitConfirm,"on_crit_confirmed")
